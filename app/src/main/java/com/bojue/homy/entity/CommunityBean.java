...
public class CommunityBean {
    ...
    public CommunityBean(String name_community, String date_community, int ID_head_sculpture, int ID_iv_community, int zan_sum_community, String content_community) {
        this.name_community = name_community;
        this.date_community = date_community;
